...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 BRD
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 BRD mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 55000000000 * COIN; // 55 bil
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // 720 blocks found a day.
    }
